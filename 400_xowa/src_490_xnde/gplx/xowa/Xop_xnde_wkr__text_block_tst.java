...
public class Xop_xnde_wkr__text_block_tst {
	...
	@Test  public void Blockquote_and_pre() { // PURPOSE: preserve leading spaces within blockquote; EX.WP: Tenerife airport disaster
		fxt.Init_para_y_();
		fxt.Test_parse_page_wiki_str(String_.Concat_lines_nl_skip_last
			(	"<blockquote>"
			,	" a"
	...
	@Test  public void Blockquote_and_following_nls() { // PURPOSE: para/pre not working after blockquote; EX:w:Snappy_(software); DATE:2014-04-25
		fxt.Init_para_y_();
		fxt.Test_parse_page_wiki_str(String_.Concat_lines_nl_skip_last
		(	"<blockquote>a"
		,	"</blockquote>"
