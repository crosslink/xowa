			...
			case Tblw_type_tb:								// <table>
				...
				switch (prv_tid) {
					...
					case Xop_tkn_itm_.Tid_tblw_tb:			// fix;  <table><table>			-> <table>; ignore current table; DATE:2014-02-02
						...
						// else								// fix:  <table><table>			-> <table><tr><td><table>; earlier tbl is tblw; auto-create; EX:it.w:Main_Page; DATE:2014-02-08; DELETED:depend on tidy to fix, else it.w:Portal:Animali doesn't get fixed by tidy; DATE:2014-05-31
						//	auto_create = true;
						break;
