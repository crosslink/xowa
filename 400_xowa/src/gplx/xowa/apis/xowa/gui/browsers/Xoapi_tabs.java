...
public class Xoapi_tabs implements GfoInvkAble {
	...
	public void New_link(boolean focus)				{tab_mgr.Tabs_new_link(focus);}
	...
	public Object Invk(GfsCtx ctx, int ikey, String k, GfoMsg m) {
		...
		else if	(ctx.Match(k, Invk_new_link__at_dflt__focus_n))			this.New_link(Bool_.N);
		else if	(ctx.Match(k, Invk_new_link__at_dflt__focus_y))			this.New_link(Bool_.Y);
