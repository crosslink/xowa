...
public class Xog_win_itm implements GfoInvkAble, GfoEvObj {
	...
	public Object Invk(GfsCtx ctx, int ikey, String k, GfoMsg m) {
		...
		else if	(ctx.Match(k, Gfui_html.Evt_link_hover))					Xog_win_itm__prog_href_mgr.Hover(this, m.ReadStr("v"));
...
class Xog_win_itm__prog_href_mgr {
	...
	public static void Hover(Xog_win_itm win, String href) {
		Gfo_usr_dlg usr_dlg = win.Usr_dlg();
		...
		Xoa_app app = win.App(); Xoa_page page = win.Active_page();  Xow_wiki wiki = page.Wiki();
