/* edit.js: Provides a toolbar for editing pages
...
function insertButton (icon, title, pre, sample, post, ownline, splitlines) {
	...
	img.src = xowa_root_dir + '/user/anonymous/app/img/edit/' + icon;
	img.title = title;
...
function init () {
	...
	createBar([
		['format-bold-B.png', i18n('bold_tip'), "'''", i18n('bold_sample'), "'''"],
		['format-italic-I.png', i18n('italic_tip'), "''", i18n('italic_sample'), "''"],
