...
public class Xow_toc_mgr implements Bry_fmtr_arg {
	...
	public static byte[] Toc_text(Xop_ctx ctx, Xoa_page page, byte[] src, Xop_hdr_tkn hdr) {
		...
		Xoh_hdom_wtr html_wtr = wiki.Html_mgr().Hdom_wtr(); html_wtr.Page_(wiki.Ctx().Cur_page());
		Xoh_html_wtr_ctx html_wtr_opts = Xoh_html_wtr_ctx.Basic;
		Toc_text_recurse(ctx, page, bfr, src, html_wtr, html_wtr_opts, hdr, 0);
		bfr.Mkr_rls();
		return bfr.XtoAryAndClear();
	}
	private static void Toc_text_recurse(Xop_ctx ctx, Xoa_page page, Bry_bfr bfr, byte[] src, Xoh_hdom_wtr html_wtr, Xoh_html_wtr_ctx html_wtr_opts, Xop_tkn_itm tkn, int depth) {
...
//							case Xop_xnde_tag_.Tid_pre: case Xop_xnde_tag_.Tid_blockquote:
						...
						case Xop_xnde_tag_.Tid_i:
							html_wtr.Write_tkn(bfr, ctx, html_wtr_opts, src, tkn, Xoh_hdom_wtr.Sub_idx_null, sub);
							break;
						case Xop_xnde_tag_.Tid_translate:
							...
							html_wtr.Write_tkn(bfr, ctx, html_wtr_opts, translate_xnde.Xtn_root().Data_mid(), tkn, Xoh_hdom_wtr.Sub_idx_null, translate_xnde.Xtn_root());
							break;
						default:
