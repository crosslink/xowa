...
public interface Xoh_module_itm {
	...
	void Write_js_script(Xoa_app app, Xow_wiki wiki, Xoa_page page, Xoh_module_wtr wtr);
	void Write_js_global(Xoa_app app, Xow_wiki wiki, Xoa_page page, Xoh_module_wtr wtr);
	void Clear();
}
/*
Position	// top, bottom
