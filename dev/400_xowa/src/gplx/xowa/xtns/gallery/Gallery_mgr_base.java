...
public abstract class Gallery_mgr_base {
	...
	public void Write_html(Bry_bfr bfr, Xow_wiki wiki, Xoa_page page, Xop_ctx ctx, byte[] src, Gallery_xnde xnde) {
		...
		Xoa_app app = wiki.App(); Xoh_hdom_wtr html_wtr = wiki.Html_mgr().Hdom_wtr();
	...
	public void Write_html_itm(Bry_bfr bfr, Bry_bfr tmp_bfr, Xoa_app app, Xow_wiki wiki, Xoa_page page, Xop_ctx ctx, Xoh_hdom_wtr html_wtr, byte[] src, Gallery_xnde xnde, byte[] gallery_ul_id, int i, Xof_xfer_itm xfer_itm) {
		...
		if (	!ttl.Ns().Id_file()
			...
			wiki.Html_mgr().Hdom_wtr().Lnki_wtr().Write_file(tmp_bfr, ctx, Xoh_html_wtr_ctx.Basic, src, lnki, xfer_itm, alt);
		...
		if (xnde.Show_filename()) {
			wiki.Html_mgr().Hdom_wtr().Lnki_wtr().Write_plain_by_bry
			( tmp_bfr, src, lnki
