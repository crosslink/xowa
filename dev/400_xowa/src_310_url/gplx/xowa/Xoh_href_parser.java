...
public class Xoh_href_parser {
	...
	private Bry_bfr bfr_encoder = Bry_bfr.reset_(255), bfr_temp = Bry_bfr.reset_(255);
	...
	public void Build_to_bfr(byte[] raw, Xow_wiki wiki, Bry_bfr bfr) {Build_to_bfr(Xoa_ttl.parse_(wiki, raw), wiki, bfr);}
	public void Build_to_bfr(Xoa_ttl ttl, Xow_wiki wiki, Bry_bfr bfr) {
